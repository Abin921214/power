...
//            System.out.println(jobject.get("city"));
//        } catch (Exception e) {
...
//        }
    ...
    public static  String getCityByLocation(String lng, String  lat){
        try {
            String s=getLocationByBaiduMap(lng, lat);
            JSONObject jobject =  JSON.parseObject(s);
            return (String)jobject.get("city");
        } catch (Exception e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
            return "";
...
//        System.out.println("--------------"+latitude+"-----------------");
        String locJson=geturl("http://api.map.baidu.com/geoconv/v1/?coords=" + longitude + "," +latitude + "&from=1&to=5&ak=f6fQBYCbScVSgOTT7BkwUYLHEALpvBRM");
        ...
        String addrJson = geturl("http://api.map.baidu.com/geocoder/v2/?ak=f6fQBYCbScVSgOTT7BkwUYLHEALpvBRM&location=" + lat + "," + lng + "&output=json&pois=1");
